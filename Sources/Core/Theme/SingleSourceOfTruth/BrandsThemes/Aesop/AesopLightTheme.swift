...
struct AesopLightTokens: Tokens {
    let assetBrandNeutralA = "aesop-a-official"
    let assetBrandNeutralB = "aesop-a-official"
...
struct AesopLightComponents: Components {
    ...
    let logoHorizontal: String = "Logo/Aesop/HorizontalLight"
    let logoVertical: String = "Logo/Aesop/VerticalLight"
}
