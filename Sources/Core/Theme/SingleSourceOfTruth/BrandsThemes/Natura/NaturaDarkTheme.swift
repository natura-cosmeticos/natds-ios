...
struct NaturaDarkTokens: Tokens {
    let assetBrandNeutralA = "natura-a-official-dark"
    let assetBrandNeutralB = "natura-b-official-dark"
...
struct NaturaDarkComponents: Components {
    ...
    let logoHorizontal: String = "Logo/Natura/HorizontalDark"
    let logoVertical: String = "Logo/Natura/VerticalDark"
}
