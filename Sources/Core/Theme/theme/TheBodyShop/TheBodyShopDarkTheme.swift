...
struct TheBodyShopDarkComponents: Components {
  ...
  let avatarColorBackground = "#7CC4BC"
  ...
  let progressIndicatorColorStroke = "#7CC4BC"
  ...
  let radioButtonColorSelectBorder = "#7CC4BC"
  let radioButtonColorSelectContent = "#7CC4BC"
  ...
  let shortcutContainedColorEnablePrimaryBackground = "#7CC4BC"
  ...
  let shortcutContainedColorHoverPrimaryBackground = "#4C938C"
  ...
  let shortcutContainedColorFocusPrimaryBackground = "#4C938C"
  ...
  let shortcutOutlinedColorEnablePrimaryBorder = "#7CC4BC"
  ...
  let shortcutOutlinedColorHoverPrimaryBorder = "#4C938C"
  ...
  let shortcutOutlinedColorFocusPrimaryBorder = "#4C938C"
