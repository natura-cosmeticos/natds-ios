...
struct ForcaDeVendasDarkTheme: Theme {
  let tokens: Tokens = ForcaDeVendasDarkTokens()
  let components: Components = ForcaDeVendasDarkComponents()
}

struct ForcaDeVendasDarkTokens: Tokens {
  ...
  let assetBrandCustomBFile = "forcadevendas-b-custom"
  ...
  let colorPrimary = "#F7AEA3"
  let colorOnPrimary = "#111111"
  let colorPrimaryLight = "#F9C1B9"
  let colorOnPrimaryLight = "#111111"
  let colorPrimaryLightest = "#FBD6D0"
  let colorOnPrimaryLightest = "#111111"
  let colorPrimaryDark = "#EF5A43"
  let colorOnPrimaryDark = "#FFFFFF"
  let colorPrimaryDarkest = "#BC2710"
  let colorOnPrimaryDarkest = "#FFFFFF"
  let colorSecondary = "#BAC0C2"
  let colorOnSecondary = "#111111"
  let colorSecondaryLight = "#CCD1D2"
  let colorOnSecondaryLight = "#111111"
  let colorSecondaryLightest = "#DDE0E1"
  let colorOnSecondaryLightest = "#111111"
  let colorSecondaryDark = "#899396"
  let colorOnSecondaryDark = "#111111"
  let colorSecondaryDarkest = "#5A6265"
...
struct ForcaDeVendasDarkComponents: Components {
  ...
  let avatarColorBackground = "#F7AEA3"
  ...
  let badgeColorPrimaryBackground = "#F7AEA3"
  let badgeColorSecondaryLabel = "#111111"
  let badgeColorSecondaryBackground = "#BAC0C2"
  ...
  let buttonTextTransform = "lowercase"
  let buttonContainedColorEnableBackground = "#F7AEA3"
  ...
  let buttonOutlinedColorEnableBorder = "#F7AEA3"
  ...
  let checkboxColorSelected = "#F7AEA3"
  let switchColorSelected = "#F7AEA3"
  let fieldColorSelected = "#F7AEA3"
  ...
  let progressIndicatorColorStroke = "#F7AEA3"
  ...
  let radioButtonColorSelectBorder = "#F7AEA3"
  let radioButtonColorSelectContent = "#F7AEA3"
  ...
  let shortcutContainedColorEnablePrimaryBackground = "#F7AEA3"
  ...
  let shortcutContainedColorHoverPrimaryBackground = "#EF5A43"
  ...
  let shortcutContainedColorFocusPrimaryBackground = "#BC2710"
  ...
  let shortcutOutlinedColorEnablePrimaryBorder = "#F7AEA3"
  ...
  let shortcutOutlinedColorHoverPrimaryBorder = "#EF5A43"
  ...
  let shortcutOutlinedColorFocusPrimaryBorder = "#EF5A43"
  ...
  let tagColorBackgroundPrimary = "#F7AEA3"
  let tagColorBackgroundSecondary = "#BAC0C2"
