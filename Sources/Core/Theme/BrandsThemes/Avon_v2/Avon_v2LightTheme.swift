...
struct Avon_v2LightTheme: Theme {
  let tokens: Tokens = Avon_v2LightTokens()
  let components: Components = Avon_v2LightComponents()
}

struct Avon_v2LightTokens: Tokens {
...
struct Avon_v2LightComponents: Components {
