...
struct NaturaLightComponents: Components {
  ...
  let shortcutContainedColorHoverPrimaryBackground = "#CD902C"
  ...
  let shortcutOutlinedColorHoverPrimaryBorder = "#CD902C"
  ...
  let shortcutOutlinedColorFocusPrimaryBorder = "#CD902C"
