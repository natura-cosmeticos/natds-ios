...
struct NaturaLightTokens: Tokens {
  ...
  let typographyDisplayFontWeight: UIFont.Weight = .black
  let typographyHeadlineFontFamily = "Helvetica Now Display"
  let typographyHeadlineFontWeight: UIFont.Weight = .bold
  let typographyBodyRegularFontFamily = "Helvetica Now Text"
  let typographyBodyRegularFontWeight: UIFont.Weight = .regular
  let typographyBodyBoldFontFamily = "Helvetica Now Text"
...
struct NaturaLightComponents: Components {
  ...
  let buttonContainedColorHoverBackground = "#CD902C"
