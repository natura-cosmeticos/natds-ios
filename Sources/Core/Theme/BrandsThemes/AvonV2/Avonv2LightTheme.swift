...
struct Avonv2LightTheme: Theme {
  let tokens: Tokens = Avonv2LightTokens()
  let components: Components = Avonv2LightComponents()
}

struct Avonv2LightTokens: Tokens {
...
struct Avonv2LightComponents: Components {
