...
struct Avonv2LightComponents: Components {
  ...
  let buttonContainedColorHoverBackground = "#B3003B"
  let buttonContainedColorHoverBorder = "#FFFFFF00"
  let buttonContainedColorHoverLabel = "#FFFFFF"
  let buttonContainedColorFocusBackground = "#80002A"
