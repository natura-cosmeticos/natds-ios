...
struct NatdsTestLightTheme: Theme {
  let tokens: Tokens = NatdsTestLightTokens()
  let components: Components = NatdsTestLightComponents()
}

struct NatdsTestLightTokens: Tokens {
...
struct NatdsTestLightComponents: Components {
