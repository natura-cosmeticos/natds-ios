...
struct Avonv3DarkTheme: Theme {
  let tokens: Tokens = Avonv3DarkTokens()
  let components: Components = Avonv3DarkComponents()
}

struct Avonv3DarkTokens: Tokens {
  ...
  let assetBrandNeutralAFile = "avonv2-b-official-dark"
  let assetBrandNeutralBFile = "avonv2-b-official-dark"
  let assetBrandCustomAFile = "avonv2-b-custom"
...
struct Avonv3DarkComponents: Components {
  ...
  let alertBorderRadius: CGFloat = 16
  ...
  let dialogBorderRadius: CGFloat = 16
  ...
  let snackbarBorderRadius: CGFloat = 16
