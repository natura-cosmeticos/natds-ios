...
struct CasaEestiloDarkTheme: Theme {
  let tokens: Tokens = CasaEestiloDarkTokens()
  let components: Components = CasaEestiloDarkComponents()
}
...
struct CasaEestiloDarkTokens: Tokens {
  ...
  let assetBrandNeutralAFile = "casaeestilo-a-official-dark"
  let assetBrandNeutralBFile = "casaeestilo-a-official-dark"
...
struct CasaEestiloDarkComponents: Components {
  ...
  let buttonTextTransform: String = "capitalize"
  ...
  let colorInputComponent = "#C2488E"
