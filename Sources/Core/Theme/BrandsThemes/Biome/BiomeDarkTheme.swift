...
struct BiomeDarkTokens: Tokens {
  let colorSecondaryDarkest = "#FFC8D4"
  let colorOnSecondaryDarkest = "#FFC8D4"
  let colorNeutralLightest = "#FFC8D4"
  let colorNeutralLight = "#FFC8D4"
  let colorNeutralDark = "#FFC8D4"
  let colorNeutralDarkest = "#FFC8D4"
