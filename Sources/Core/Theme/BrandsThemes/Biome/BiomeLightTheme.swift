...
struct BiomeLightTheme: Theme {
  let tokens: Tokens = BiomeLightTokens()
  let components: Components = BiomeLightComponents()
}
...
struct BiomeLightTokens: Tokens {
  ...
  let assetBrandNeutralAFile = "biome-a-official"
  let assetBrandNeutralAWidth: CGFloat = 256
  let assetBrandNeutralAHeight: CGFloat = 82
  let assetBrandNeutralBFile = "natura-a-custom"
...
struct BiomeLightComponents: Components {
  ...
  let avatarColorBackground = "#DACABB"
  ...
  let badgeColorPrimaryBackground = "#DACABB"
  let badgeColorSecondaryLabel = "#FFFFFF"
  let badgeColorSecondaryBackground = "#00892F"
  ...
  let buttonContainedColorEnableBackground = "#DACABB"
  ...
  let buttonOutlinedColorEnableBorder = "#DACABB"
  ...
  let progressIndicatorColorStroke = "#DACABB"
  ...
  let radioButtonColorSelectBorder = "#DACABB"
  let radioButtonColorSelectContent = "#DACABB"
  ...
  let shortcutContainedColorEnablePrimaryBackground = "#DACABB"
  ...
  let shortcutContainedColorHoverPrimaryBackground = "#A8998B"
  ...
  let shortcutOutlinedColorHoverPrimaryBorder = "#A8998B"
  ...
  let tagColorBackgroundPrimary = "#DACABB"
  let tagColorBackgroundSecondary = "#00892F"
