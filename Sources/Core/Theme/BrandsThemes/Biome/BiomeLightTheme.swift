...
struct BiomeLightComponents: Components {
  ...
  let buttonContainedColorHoverBackground = "#A8998B"
  let buttonContainedColorHoverBorder = "#FFFFFF00"
  let buttonContainedColorHoverLabel = "#333333"
  let buttonContainedColorFocusBackground = "#A8998B"
  ...
  let iconButtonStandardColorHoverBackground = "#EEEEEE"
  let iconButtonStandardColorFocusBackground = "#E3E3E3"
  let iconButtonFloatColorEnableBackground = "#FFFFFF"
  let iconButtonFloatColorDisableBackground = "#BBBBBB"
  let iconButtonFloatColorHoverBackground = "#EEEEEE"
  let iconButtonFloatColorFocusBackground = "#E3E3E3"
  ...
  let shortcutOutlinedColorHoverPrimaryBackground = "#EEEEEE"
