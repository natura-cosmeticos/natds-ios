...
struct Naturav3LightComponents: Components {
  ...
  let buttonBorderRadius: CGFloat = 25
  ...
  let buttonContainedColorHoverBackground = "#E05A0D"
  let buttonContainedColorHoverBorder = "#FFFFFF00"
  let buttonContainedColorHoverLabel = "#111111"
  let buttonContainedColorFocusBackground = "#953C09"
