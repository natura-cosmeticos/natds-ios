enum GaYaShortcutContainedStyle {
    static func apply(_ theme:AvailableTheme, on shortcut: GaYaShortcut) {
        apply(theme, on: shortcut, color: shortcut.color)
    }

    static func apply(_ theme:AvailableTheme, on shortcut: GaYaShortcut, color: GaYaShortcut.Color) {
    ...
    static func applyPrimaryStyle(_ theme:AvailableTheme, on shortcut: GaYaShortcut) {
        apply(theme, on: shortcut, color: .primary)
    }

    static func applyDefaultStyle(_ theme:AvailableTheme, on shortcut: GaYaShortcut) {
