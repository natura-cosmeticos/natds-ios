/**
  DSBorderRadius is a enum that has access to radius properties from the Design System.
  ...
  According with the current Brand in the Design System this properties can change.
    ...
    Exemple of usage:
        ...
        containerView.layer.cornerRadius = DSBorderRadius.small
        button.layer.cornerRadius = DSBorderRadius.circle(viewHeight: DSSizes.large)
