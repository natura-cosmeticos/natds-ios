...
public final class GaYaTag: UIView {
    ...
    private func addConstraints() {
        ...
        if icon != nil {
            if (iconPosition == .left || iconPosition == nil) {
                constraints = [
                ...
                constraints = [
                    iconView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -getTokenFromTheme(\.spacingTiny)),
                    iconView.heightAnchor.constraint(equalToConstant: size.value),
                    iconView.widthAnchor.constraint(equalToConstant: size.value),
                    iconView.centerYAnchor.constraint(equalTo: centerYAnchor),
                    label.trailingAnchor.constraint(equalTo: iconView.leadingAnchor,
                                                   constant: -getTokenFromTheme(\.spacingMicro)),
                    label.leadingAnchor.constraint(equalTo: leadingAnchor, constant: getTokenFromTheme(\.spacingTiny)),
                    label.centerYAnchor.constraint(equalTo: centerYAnchor)
                ]
            }
