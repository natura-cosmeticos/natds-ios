public enum Icon: String, CaseIterable {
    ...
    case filledNavigationArrowCtrlRegularLeft = "filled-navigation-arrowctrregularleft"
    case filledNavigationArrowCtrlRegularRight = "filled-navigation-arrowctrregularright"
