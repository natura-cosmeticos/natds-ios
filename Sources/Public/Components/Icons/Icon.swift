...
extension Icon {
    var unicode: String {
        ...
        case .outlinedAlertNotification: return "\u{EA56}"
        case .outlinedAlertWarning: return "\u{EA57}"
        case .outlinedCommunicationChat: return "\u{EA58}"
        case .outlinedCommunicationEmail: return "\u{EA59}"
        case .outlinedCommunicationHelp: return "\u{EA5A}"
        case .outlinedCommunicationMessage: return "\u{EA5B}"
        case .outlinedCommunicationOccurrence: return "\u{EA5C}"
        case .outlinedCommunicationReadEmail: return "\u{EA5D}"
        case .outlinedCommunicationSignal: return "\u{EA5E}"
        case .outlinedCommunicationSpeaker: return "\u{EA5F}"
        case .outlinedCommunicationTreatment: return "\u{EA60}"
        case .outlinedContentAdddocument: return "\u{EA61}"
        case .outlinedContentAgility: return "\u{EA62}"
        case .outlinedContentBellringing: return "\u{EA63}"
        case .outlinedContentBook: return "\u{EA64}"
        case .outlinedContentBrightness: return "\u{EA65}"
        case .outlinedContentChangeview: return "\u{EA66}"
        case .outlinedContentChannel: return "\u{EA67}"
        case .outlinedContentChristmascard: return "\u{EA68}"
        case .outlinedContentConsistency: return "\u{EA69}"
        case .outlinedContentDivulgation: return "\u{EA6A}"
        case .outlinedContentEducation: return "\u{EA6B}"
        case .outlinedContentExchangereports: return "\u{EA6C}"
        case .outlinedContentGallery: return "\u{EA6D}"
        case .outlinedContentGift: return "\u{EA6E}"
        case .outlinedContentGlobal: return "\u{EA6F}"
        case .outlinedContentHealth: return "\u{EA70}"
        case .outlinedContentHealthy: return "\u{EA71}"
        case .outlinedContentIndicator: return "\u{EA72}"
        case .outlinedContentLock: return "\u{EA73}"
        case .outlinedContentMagic: return "\u{EA74}"
        case .outlinedContentMedal: return "\u{EA75}"
        case .outlinedContentMenu: return "\u{EA76}"
        case .outlinedContentMirror: return "\u{EA77}"
        case .outlinedContentPlanb: return "\u{EA78}"
        case .outlinedContentProdutivity: return "\u{EA79}"
        case .outlinedContentReport: return "\u{EA7A}"
        case .outlinedContentStore: return "\u{EA7B}"
        case .outlinedContentWellness: return "\u{EA7C}"
        case .outlinedContentWifi: return "\u{EA7D}"
        case .outlinedDefaultMockup: return "\u{EA7E}"
        case .outlinedFinanceBag: return "\u{EA7F}"
        case .outlinedFinanceBank: return "\u{EA80}"
        case .outlinedFinanceCards: return "\u{EA81}"
        case .outlinedFinanceCharging: return "\u{EA82}"
        case .outlinedFinanceCreditcard: return "\u{EA83}"
        case .outlinedFinanceDebit: return "\u{EA84}"
        case .outlinedFinanceDiscount: return "\u{EA85}"
        case .outlinedFinanceLittlemachine: return "\u{EA86}"
        case .outlinedFinanceMoney: return "\u{EA87}"
        case .outlinedFinanceMoneypaper: return "\u{EA88}"
        case .outlinedFinancePromotion: return "\u{EA89}"
        case .outlinedFinanceShoppingcart: return "\u{EA8A}"
        case .outlinedFinanceShoppingcartproduct: return "\u{EA8B}"
        case .outlinedFinanceTagdiscount: return "\u{EA8C}"
        case .outlinedFinanceTransfermoney: return "\u{EA8D}"
        case .outlinedMediaApp: return "\u{EA8E}"
        case .outlinedMediaCamera: return "\u{EA8F}"
        case .outlinedMediaMonitor: return "\u{EA90}"
        case .outlinedMediaPlay: return "\u{EA91}"
        case .outlinedNavigationArrowbottom: return "\u{EA92}"
        case .outlinedNavigationArrowleft: return "\u{EA93}"
        case .outlinedNavigationArrowright: return "\u{EA94}"
        case .outlinedNavigationArrowtop: return "\u{EA95}"
        case .outlinedNavigationClose: return "\u{EA96}"
        case .outlinedNavigationDirectionbottom: return "\u{EA97}"
        case .outlinedNavigationDirectionleft: return "\u{EA98}"
        case .outlinedNavigationDirectionright: return "\u{EA99}"
        case .outlinedNavigationDirectiontop: return "\u{EA9A}"
        case .outlinedNavigationExit: return "\u{EA9B}"
        case .outlinedNavigationGoback: return "\u{EA9C}"
        case .outlinedNavigationGofront: return "\u{EA9D}"
        case .outlinedNavigationHome: return "\u{EA9E}"
        case .outlinedNavigationMenu: return "\u{EA9F}"
        case .outlinedPlaceBus: return "\u{EAA0}"
        case .outlinedPlaceForklift: return "\u{EAA1}"
        case .outlinedPlaceGps: return "\u{EAA2}"
        case .outlinedPlaceLocal: return "\u{EAA3}"
        case .outlinedPlaceRocket: return "\u{EAA4}"
        case .outlinedPlaceRunningtruck: return "\u{EAA5}"
        case .outlinedPlaceTruck: return "\u{EAA6}"
        case .outlinedPlaceWaze: return "\u{EAA7}"
        case .outlinedProductBagproduct: return "\u{EAA8}"
        case .outlinedProductBeard: return "\u{EAA9}"
        case .outlinedProductBrandsproduct: return "\u{EAAA}"
        case .outlinedProductChildish: return "\u{EAAB}"
        case .outlinedProductDailycare: return "\u{EAAC}"
        case .outlinedProductHair: return "\u{EAAD}"
        case .outlinedProductMakeup: return "\u{EAAE}"
        case .outlinedProductOutlet: return "\u{EAAF}"
        case .outlinedProductPerfumery: return "\u{EAB0}"
        case .outlinedProductPromotionproduct: return "\u{EAB1}"
        case .outlinedProductVegan: return "\u{EAB2}"
        case .outlinedSocialAddcontact: return "\u{EAB3}"
        case .outlinedSocialBirthday: return "\u{EAB4}"
        case .outlinedSocialCollaborate: return "\u{EAB5}"
        case .outlinedSocialContact: return "\u{EAB6}"
        case .outlinedSocialDigitalconsultant: return "\u{EAB7}"
        case .outlinedSocialGroupofpeople: return "\u{EAB8}"
        case .outlinedSocialMyprofile: return "\u{EAB9}"
        case .outlinedSocialNetwork: return "\u{EABA}"
        case .outlinedSocialPerson: return "\u{EABB}"
        }
    }
}
