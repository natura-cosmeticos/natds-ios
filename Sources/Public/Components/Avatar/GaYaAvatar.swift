...
public final class GaYaAvatar: UIView {
...
extension GaYaAvatar {
    /// Sets the label text for GaYaAvatar with `label` type
    ...
    /// Sets an image for GaYaAvatar with `image` type
    ...
    /// Sets a remote image for GaYaAvatar with `image` type
    ...
    /// - Parameter setFallbackIcon: An icon from Icons, which is sent as a string.
    ...
    /// Sets an icon for GaYaAvatar with `icon` type
    /// - Parameter icon: An icon from Icons, which is sent as a string. Example: `getIcon(.outlinedDefaultMockup)`
    ...
    /// Sets the default icon `outlinedDefaultMock` for GaYaAvatar.
