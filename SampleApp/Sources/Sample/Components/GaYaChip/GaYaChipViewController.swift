...
class GaYaChipViewController: UIViewController, SampleItem {
    static var name = "GaYaChip"
    ...
    private let rightIconChip: GaYaChip = {
        let icon = getIcon(.outlinedDefaultMockup)
        let chip = GaYaChip()
    ...
    private let bothSidesIconChip: GaYaChip = {
        let icon = getIcon(.outlinedDefaultMockup)
        let chip = GaYaChip()
    ...
    private let leftAvatarChip: GaYaChip = {
    ...
    private let rightAvatarChip: GaYaChip = {
        let avatar = GaYaAvatar(size: .standard, type: .label)
        avatar.configure(name: "Design System")
        let chip = GaYaChip()
    ...
    private let iconAndAvatarChip: GaYaChip = {
        let icon = getIcon(.outlinedDefaultMockup)
        let avatar = GaYaAvatar(size: .standard, type: .label)
        avatar.configure(name: "Design System")
        let chip = GaYaChip()
    ...
    private let avatarAndIconChip: GaYaChip = {
        let icon = getIcon(.outlinedDefaultMockup)
        let avatar = GaYaAvatar(size: .standard, type: .label)
        avatar.configure(name: "Design System")
        let chip = GaYaChip()
...
//    private let focusedChip: GaYaChip = {
//        let chip = GaYaChip()
